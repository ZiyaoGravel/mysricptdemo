...
/*    //Get the help button
    ...
    button.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        intent.setClass(MainActivity.this, CvPage1.class);//turn to the second activity
...
/*  public void onEmoticonButtonClick(View v) {
  ...
  public void onConfirmClick(View v) {
    ...
    try{
      if(mWidget.getText().toString().equals("edu")||
              mWidget.getText().toString().equals("Edu")||
              mWidget.getText().toString().equals("EDU")
              ) {
        intent.setClass(MainActivity.this, CvPage1.class);//turn to the second activity
        startActivity(intent);
      }
      if(mWidget.getText().toString().equals("int")||
              mWidget.getText().toString().equals("Int")||
              mWidget.getText().toString().equals("INT")
              ){
        intent.setClass(MainActivity.this, CvPage2.class);//turn to the second activity
        startActivity(intent);
      }
      if(mWidget.getText().toString().equals("exp")||
              mWidget.getText().toString().equals("Exp")||
              mWidget.getText().toString().equals("EXP")
              ){
        intent.setClass(MainActivity.this, CvPage3.class);//turn to the second activity
        startActivity(intent);
      }
    }catch (Exception ex){
